...
<body>
	...
	<form action="/ncpl/pcolor/test" method="post">
		<input class="name" type="hidden" name="qNo" value="${qNo}">
		<div class="progress">
    		<div class="value" style="width:${progress}%"></div>
  		</div>
		<div class="question-box">
	 	 	<div class="question">${pcolor.content}</div>
	 		<button class="btn btn-gray choice choice1" type="submit" name="op" value="ans1">${pcolor.ans1}</button>
	 	 	<button class="btn btn-gray choice choice2" type="submit" name="op" value="ans2">${pcolor.ans2}</button>
		</div>
